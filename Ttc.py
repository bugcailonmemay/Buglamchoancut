...
{thanh} Bạn Đang Sử Dụng Tool: Tương Tác Chéo Facebook Vip Pro Như Khánh Đẹp Trai 😆''')
    thanhngang(50)
...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''[REVIEWTOOL247][ TTC ][{str(value)[0:5]}][X    ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[REVIEWTOOL247][ TTC ][{str(value)[0:5]}][ X   ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[REVIEWTOOL247][ TTC ][{str(value)[0:5]}][  X  ]''', '               ', end = '\r')
...
def chongblock(delaybl):
	for i in range(delaybl, -1, -1):
		Write.Print(f'Đang hoạt động chống block sẽ chạy lại sau {i} giây  \r',interval=0.0001);sleep(1); print('                                                        ', end = '\r')
...
def Nhap_Cookie():
    ...
    while True:
        demck += 1
        ck = input(f'Nhập Cookie Facebook Thứ: {demck}: ')
        if ck == '' and demck > 1:
            break
        _info = _Infofb(ck)
        if _info == False:
            ...
            print("═"*50)
            print(f'UID FACEBOOK: {_info[1]} | NAME FACEBOOK: {_info[2]}')
            print("═"*50)
            listck.append(ck)
    return listck
...
def Main():
    ...
    while True:
        if os.path.exists('configttc.txt'):
            ...
            if login.json()['status'] == 'success':
                ...
                print(f'Nhập [1] Giữ Lại Tài Khoản {user}')
                print(f'Nhập [2] Nhập Access_Token TTC Mới')
                chon = Write.Input(f'Nhập Lựa Chọn Của Bạn: ',Colors.white,interval=0.0001)
                if chon == '2':
                    os.remove('configttc.txt')
                elif chon == '1':
                    pass
                else:
                    print(f'Lựa chọn không xác định !!!')
                    continue
            else:
                os.remove('configttc.txt')
        if not os.path.exists('configttc.txt'):
            tk = input(f'Nhập Access_token TTC: ')
        ...
        if login.json()['status'] == 'success':
            ...
            print("═"*50)
            print(f"Tên Tài Khoản: {user} | Xu Hiện Tại: {sodu}")
            print("═"*50)
            break
        else:
            os.remove ('configttc.txt')
    ...
    while True:
        if os.path.exists('Cookie_FB.txt'):
            print(f'Nhập [1] Sử Dụng Cookie Facebook Đã Lưu ')
            print(f'Nhập [2] Nhập Cookie Facebook Mới')
            chon = Write.Input(f'Nhập Lựa Chọn Của Bạn: ',Colors.white,interval=0.0001)
            if chon == '1':
                print('Đang Lấy Dữ Liệu Đã Lưu')
                sleep(1)
    ...
    banner()
    print("═"*50)
    print(f"Tên Tài Khoản: {user} | Xu Hiện Tại: {sodu} | Số Nick Facebook: {len(listck)}")
    print("═"*50)
    Write.Print('''[1] - LIKEVIP\n[2] - LIKETHUONG\n[3] - REACTIONVIP\n[4] - REACTION\n[5] - REACTIONCMT\n[6] - CMTCHEO\n[7] - SHARE\n[8] - LIKEPAGE\n[9] - FOLLOW\n[X] - Có Thể Chọn Nhiều Nhiệm Vụ (VD: 123...)\n''',Colors.white,interval=0.0001)
    print("═"*50)
    nhiemvu = input (f'Nhập Nhiệm Vụ Cần Chạy: ')
    min = int(input(f'Nhập Delay Min: '))
    max = int(input(f'Nhập Delay Max: '))
    nvblock = int(input(f'Sau Bao Nhiêu Nhiệm Vụ Thì Chống Block: '))
    delaybl = int(input(f'Sau {nvblock} Nhiệm Vụ Thì Nhiệm Vụ Nghỉ Ngơi: '))
    doinick = int(input(f'Sau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: '))
    nhiemvuloi = int(input(f'Lỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie: '))
    while True:
        if len(listck) == 0:
        ...
        for ck in listck:
            ...
            if '1' in cauhinh:
                print("═"*50)
                print(f"      Đang Chạy UID FB: {uidfb} | Tên FB: {tenfb}")
                print("═"*50)
            else:
                print("═"*50)
                print(f"  Cấu Hình Thất Bại UID FB: {uidfb} | Tên FB: {tenfb}")
                print("═"*50)
                continue
            ptool = 0
            while True:
                ...
                if nvlikevip == 1:
                    ...
                    like2 = listlike.json()
                    if like1 == []:
                        print(f'Hết Nhiệm Vụ Like Vip                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikevip = 0
                    elif 'error' in like2:
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Like Vip                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if like == False:
                                print(f"FAIL LIKE: {uid_hidden}             ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                ...
                                if 'mess' in nhan:
                                    ...
                                    print(f'[{dem:04d}][{time}][{uid_hidden}][+1100][{xu}][LIKEVIP]')
                                    loilike = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                            ...
                            if loilike >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'Tài Khoản {tenfb} Đã Bị Block Like !!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvlikethuong == 1:
                    ...
                    like2 = listlike.json()
                    if like1 == []:
                        print(f'Hết Nhiệm Vụ Like Thường                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikethuong = 0
                    elif 'error' in like2:
                        print(f'Lấy nhiệm vụ sau 10 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(10)
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Like Xu Thường                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvreacvip == 1:
                    ...
                    like2 = listcx.json()
                    if like1 == []:
                        print(f'Hết Nhiệm Vụ Cảm Xúc Vip                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreacvip = 0
                    elif 'error' in like2:
                        print(f'Lấy nhiệm vụ sau 10 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(10)
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Cảm Xúc Vip                       ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvreac == 1:
                    ...
                    like2 = listcx.json()
                    if like1 == []:
                        print(f'Hết Nhiệm Vụ Cảm Xúc                           ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreac = 0
                    elif 'error' in like2:
                        print(f'Lấy nhiệm vụ sau 10 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(10)
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Cảm Xúc                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvreaccmt == 1:
                    ...
                    if like1 == []:
                        print(f'Hết Nhiệm Vụ Cảm Xúc Cmt             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreaccmt = 0
                    elif 'error' in like2:
                        print(f'Lấy nhiệm vụ sau 10 giây                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        countdown(10)
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Cảm Xúc Cmt                     ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvfollow == 1:
                    ...
                    if like1 == []:
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Follow                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvcmt == 1:
                    ...
                    if like1 == []:
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Cmt                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvshare == 1:
                    ...
                    if like1 == []:
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Share                      ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                ...
                if nvlikepage == 1:
                    ...
                    if like1 == []:
                        ...
                        print(f'Tìm Thấy {len(like2)} Nhiệm Vụ Like Page                     ', end = '\r')
                        for x in like2:
                            try:
                                idpost = x['idpost']
                                link = x['link']
                            ...
                            if loilikepage >= nhiemvuloi:
                                ...
                                if _info !=False:
                                    ...
                                    print(f'Tài Khoản {tenfb} Đã Bị Block Like Page!!!					')
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if loilike + loicamxuc + loicxcmt + loifl + loicmt + loishare + loilikepage == 0:
                    for i in range(10, 0, -1):
                        Write.Print(f' Tất Cả Các Nhiệm Vụ Đã Hết, Vui Lòng Chờ {i} Giây ',Colors.white,interval=0.0001, end = '\r');sleep(1); print('                                                        ', end = '\r')
