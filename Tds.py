...
"""
    print(banner)
    thanhngang(50)
    print(f'''{thanh} Admin: Duy Khánh Đẹp Trai Vip Pro 😆
{thanh} Bạn Đang Sử Dụng Tool: Trao Đổi Sub Facebook Vip Pro Như Khánh Đẹp Trai 😆''')
    thanhngang(50)
         
def Delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''[REVIEWTOOL247] [DELAY] [{str(value)[0:5]}] [X    ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[REVIEWTOOL247] [DELAY] [{str(value)[0:5]}] [ X   ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''[REVIEWTOOL247] [DELAY] [{str(value)[0:5]}] [  X  ]''', '               ', end = '\r')
...
def Nhap_Cookie():
    ...
    while True:
        ...
        if 'success' in info:
            ...
            thanhngang(50)
            print(f'''{thanh} Trạng Thái Acc: [DIE]\n{thanh} Tin Nhắn: Đăng Nhập Thất Bại''')
            demck-=1
            thanhngang(50)
    return listck

def Nhap_Setting():
    apikey = input(f'{thanh} Nhập Apikey 3xcaptcha Để Auto Add Cấu Hình (Enter để bỏ qua): ')
...
def Main():
    ...
    if proxy_list:
        ...
        if is_live == False:
            print(f'Proxy Không Hoạt Động!                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
            myip = None
        else:
            print(f'Proxy Hoạt Động!                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
    ...
    while True:
        ...
        if not os.path.exists('acc_tds_log.txt'):
            username, password = input(f'{thanh} Nhập Tài Khoản TDS: '), input(f'{thanh} Nhập Mật Khẩu TDS: ')
            thanhngang(50)
    ...
    while True:
        ...
        for ck in listck:
            ...
            if 'success' in info:
                ...
                print(f'Cookie Tài Khoản {uid} Die', end='\r');sleep(1); print('                                     ', end = '\r' )
                listck.remove(ck)
                continue
            if chonan == 'y':
                    ...
                    if get_g_recaptcha_response[0] == True:
                        ...
                        if add_uid[0] == True:
                            ...
                            if cauhinh == True:
                                ...
                                print(f'Cấu Hình Thất Bại Id Facebook: {uid} | Tên Tài khoản: {name}')
                                listck.remove(ck)
                                continue
                        else:
                            print(f'Thêm Cấu Hình Thất Bại Id Facebook: {uid} | Tên Tài khoản: {name}')
                            listck.remove(ck)
                            continue
                    else:
                        print(f'Thêm Cấu Hình Thất Bại Id Facebook: {uid} | Tên Tài khoản: {name}')
            ...
            while True:
                ...
                if '1' in nhiemvu:
                    ...
                    if listcx == False:
                        print(f'Không Get Được Nhiệm Vụ Cảm Xúc                           ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                    elif 'error' in listcx:
                        if listcx['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listcx['countdown']
                            print(f'Đang Get Nhiệm Vụ Cảm Xúc, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                        ...
                        list_nv = listcx['data']
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Cảm Xúc                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Cảm Xúc                      ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                ...
                                if like == False:
                                    print(f"FAIL {type}: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loireaction += 1
                                else:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        print(f'[{dem}][{time}][{type}][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                                ...
                                if loireaction >= nhiemvuloi:
                                    ...
                                    checktt = fb2.info()
                                    if 'error' in checktt:
                                        print(f'Cookie Tài Khoản {name} Đã Bị Out or Checkpoint !!!                ')
                                        listck.remove(ck)
                                        ptool = 1
                                        break
                                    else:
                                        print(f'Tài Khoản {name} Đã Bị Block Cảm Xúc                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '2' in nhiemvu:
                    ...
                    if listcxcmt == False:
                        print(f'Không Get Được Nhiệm Vụ Cảm Xúc Cmt                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listcxcmt:
                        if listcxcmt['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listcxcmt['countdown']
                            print(f'Đang Get Nhiệm Vụ Follow, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                        ...
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Cảm Xúc Cmt                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Cảm Xúc Cmt                     ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split('_')[1] if '_' in idpost else idpost
                                id2 = id[:3]+'#'*(len(id)-6)+id[-3:]
                                ...
                                if like == False:
                                    print(f"FAIL {type}CMT: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loicxcmt += 1
                                else:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'[{dem}][{time}][{type}CMT][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                                ...
                                if loicxcmt >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Cảm Xúc Cmt                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '3' in nhiemvu:
                    ...
                    if listshare == False:
                        print(f'Không Get Được Nhiệm Vụ Share                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listshare:
                        if listshare['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listshare['countdown']
                            print(f'Đang Get Nhiệm Vụ Share, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                        ...
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Share                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Share                     ', end = '\r')
                        for x in list_nv:
                            idpost = x['id']
                            id = idpost.split('_')[1] if '_' in idpost else idpost
                            id2 = id[:3]+'#'*(len(id)-6)+id[-3:]
                            ...
                            like = fb.share(id)
                            if like == False:
                                print(f"FAIL SHARE: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                Delay(3)
                                loishare += 1
                            else:
                                ...
                                if 'success' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'[{dem}][{time}][SHARE][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                ...
                                if loishare >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Share                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '4' in nhiemvu:
                    ...
                    if listfl == False:
                        print(f'Không Get Được Nhiệm Vụ Follow                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        ...
                        list_nv = listfl['data']
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Follow                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Follow                     ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split('_')[1] if '_' in idpost else idpost
                                id2 = id[:3]+'#'*(len(id)-6)+id[-3:]
                                ...
                                like = fb.follow(id)
                                if like == False:
                                    print(f"FAIL FOLLOW: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loifollow += 1
                                else:
                                    ...
                                    loifollow = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'[{dem}][{time}][FOLLOW][{id2}][{cache}/5]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                    ...
                                    if cache >= 5:
                                        ...
                                        if 'success' in nhan:
                                            ...
                                            time = datetime.now().strftime("%H:%M:%S")
                                            print(f'[X][{time}][FOLLOW][NHẬN XU][{job_success}/{cache}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                ...
                                if loifollow >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Follow                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '5' in nhiemvu:
                    ...
                    if listpage == False:
                        print(f'Không Get Được Nhiệm Vụ Like Page                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        ...
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Like Page                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Like Page                     ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split('_')[1] if '_' in idpost else idpost
                                id2 = id[:3]+'#'*(len(id)-6)+id[-3:]
                                ...
                                if like == False:
                                    print(f"FAIL LIKEPAGE: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loipage+=1
                                else:
                                    ...
                                    loipage = 0
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'[{dem}][{time}][LIKEPAGE][{id2}][{cache}/5]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                    ...
                                    if cache >= 5:
                                        ...
                                        if 'success' in nhan:
                                            ...
                                            job_success = nhan['data']['job_success']
                                            time = datetime.now().strftime("%H:%M:%S")
                                            print(f'[X][{time}][LIKEPAGE][NHẬN XU][{job_success}/{cache}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                ...
                                if loipage >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Like Page                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '6' in nhiemvu:
                    ...
                    if listgr == False:
                        print(f'Không Get Được Nhiệm Vụ Group                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listgr:
                        if listgr['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listgr['countdown']
                            print(f'Đang Get Nhiệm Vụ Group, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                        ...
                        list_nv = listgr
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Group                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Group                     ', end = '\r')
                        for x in list_nv:
                            idpost = x['id']
                            id2 = idpost[:3]+'#'*(len(idpost)-6)+idpost[-3:]
                            like = fb.group(idpost)
                            if like == False:
                                print(f"FAIL GROUP: {idpost}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                Delay(3)
                                loigr += 1
                            else:
                                ...
                                if 'success' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'[{dem}][{time}][GROUP][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                ...
                                if loigr >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Group                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '7' in nhiemvu:
                    ...
                    if listshare == False:
                        print(f'Không Get Được Nhiệm Vụ Share Thường                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listshare:
                        if listshare['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listshare['countdown']
                            print(f'Đang Get Nhiệm Vụ Share Thường, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                            print(listshare['error'], end = '\r'); sleep(1); print('                                                       ', end = '\r')
                    else:
                        list_nv = listshare
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Share Thường                           ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Share Thường                     ', end = '\r')
                        for x in list_nv:
                            idpost = x['id']
                            id2 = idpost[:3]+'#'*(len(idpost)-6)+idpost[-3:]
                            share = fb.share(idpost)
                            if share == False:
                                print(f"FAIL SHARE: {idpost}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                Delay(3)
                                loisharet += 1
                            else:
                ...
                if '8' in nhiemvu:
                    ...
                    if listpage == False:
                        print(f'Không Get Được Nhiệm Vụ Like Page Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listpage:
                        if listpage['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listpage['countdown']
                            print(f'Đang Get Nhiệm Vụ Like Page Thường, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                            print(listpage['error'], end = '\r'); sleep(1); print('                                                       ', end = '\r')
                    else:
                        list_nv = listpage
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Like Page Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Like Page Thường                    ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                id2 = idpost[:3]+'*'*(len(idpost)-6)+idpost[-3:]
                                like = fb.like_page(idpost)
                                if like == False:
                                    print(f"FAIL LIKEPAGE: {idpost}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loipage+=1
                                else:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'[{dem}][{time}][LIKEPAGETHUONG][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                ...
                if '9' in nhiemvu:
                    ...
                    if listlike == False:
                        print(f'Không Get Được Nhiệm Vụ Like Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listlike:
                        if listlike['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listlike['countdown']
                            print(f'Đang Get Nhiệm Vụ Like Thường, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                        ...
                        list_nv = listlike
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Like Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Like Thường                    ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                id = idpost.split('_')[1] if '_' in idpost else idpost
                                id2 = id[:3]+'*'*(len(id)-6)+id[-3:]
                                ...
                                if like == False:
                                    print(f"FAIL LIKETHUONG: {id}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                    Delay(3)
                                    loiliket+=1
                                else:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'[{dem}][{time}][LIKETHUONG][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
                                ...
                                if loiliket >= nhiemvuloi:
                                    ...
                                    if 'error' in checktt:
                                        ...
                                        print(f'Tài Khoản {name} Đã Bị Block Like                            ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                ...
                if '0' in nhiemvu:
                    ...
                    if listlike == False:
                        print(f'Không Get Được Nhiệm Vụ Cảm Xúc Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                    elif 'error' in listlike:
                        if listlike['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                            count = listlike['countdown']
                            print(f'Đang Get Nhiệm Vụ Cảm Xúc Thường, COUNTDOWN: {str(round(count, 3))}              ', end = '\r'); sleep(1); print('                                                       ', end = '\r')
                            Delay(count)
                        else:
                            print(listlike['error'], end = '\r'); sleep(1); print('                                                       ', end = '\r')
                    else:
                        list_nv = listlike
                        if len(list_nv) == 0:
                            print(f'Hết Nhiệm Vụ Cảm Xúc Thường                          ', end = '\r');sleep(1); print('                                                        ', end = '\r')
                        else:
                            print(f'Tìm Thấy {len(list_nv)} Nhiệm Vụ Cảm Xúc Thường                    ', end = '\r')
                            for x in list_nv:
                                idpost = x['id']
                                type = x['type']
                                id = idpost.split('_')[1] if '_' in idpost else idpost
                                ...
                                if like == False:
                                    ...
                                    if 'success' in nhan:
                                        ...
                                        dem+=1
                                        time = datetime.now().strftime("%H:%M:%S")
                                        print(f'[{dem}][{time}][{type}THUONG][{id2}][{msg}][{str(format(int(xu),","))}][{myip}]')
                                        if dem % doinick == 0:
                                            ptool = 1
                                            break
                                        if dem % nvblock == 0:
